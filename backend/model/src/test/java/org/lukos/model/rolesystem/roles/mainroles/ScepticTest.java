...
/**
 * Test cases for {@link Sceptic}.
 *
 * @author Rick van der Heijden (1461923)
 * @since 12-04-2022
 */
public class ScepticTest {
    /** An instance of {@link Sceptic} that can be used throughout the test cases. */
    private Role sceptic;

    @BeforeEach
    public void setUp() {
        this.sceptic = new Sceptic();
    }

    /** @utp.description Tests whether the constructor is demonstrating the correct functionality */
    @Test
    public void constructorTest1() {
        assertEquals(CharacterType.NOT_SHADY, sceptic.getCharacter());
        assertEquals(Group.TOWNSPEOPLE, sceptic.getGroup());
    }

    /** @utp.description Tests whether the constructor is demonstrating the correct functionality */
    @Test
    public void constructorTest2() {
        Sceptic sceptic = new Sceptic(true);
        assertEquals(CharacterType.NOT_SHADY, sceptic.getCharacter());
        assertEquals(Group.TOWNSPEOPLE, sceptic.getGroup());
    }
    ...
    public void initializeActionsTest() {
        ...
        try {
            sceptic.initializeActions(null);
        } catch (Exception e) {
    ...
    public void performActionTest() {
        Class<?> expected = UnsupportedOperationException.class;
        try {
            sceptic.performAction(null, null);
        } catch (Exception e) {
            assertTrue(expected.isInstance(e),
                    "type: " + e.getClass().getName() + " should have be instance of " + expected);
            assertNotNull(e.getMessage(), "Message should not be null");
    ...
    public void getInformationTest() {
        Class<?> expected = UnsupportedOperationException.class;
        try {
            sceptic.getInformation(null, null);
        } catch (Exception e) {
            assertTrue(expected.isInstance(e),
                    "type: " + e.getClass().getName() + " should have be instance of " + expected);
            assertNotNull(e.getMessage(), "Message should not be null");
    ...
    public void replenishActionTest() {
        Class<?> expected = UnsupportedOperationException.class;
        try {
            sceptic.replenishAction(-1, null);
        } catch (Exception e) {
            assertTrue(expected.isInstance(e),
                    "type: " + e.getClass().getName() + " should have be instance of " + expected);
            assertNotNull(e.getMessage(), "Message should not be null");
