...
/**
 * Test cases for {@link Scout}.
 *
 * @author Rick van der Heijden (1461923)
 * @since 12-04-2022
 */
public class ScoutTest {
    /** An instance of {@link Scout} that can be used throughout the test cases. */
    private Role scout;
    ...
    public void constructorTest1() {
        assertEquals(CharacterType.NOT_SHADY, scout.getCharacter());
        assertEquals(Group.TOWNSPEOPLE, scout.getGroup());
    }
    ...
    public void getInformationTest() {
        Class<?> expected = UnsupportedOperationException.class;
        try {
            scout.getInformation(null, null);
        } catch (Exception e) {
            assertTrue(expected.isInstance(e),
                    "type: " + e.getClass().getName() + " should have be instance of " + expected);
            assertNotNull(e.getMessage(), "Message should not be null");
