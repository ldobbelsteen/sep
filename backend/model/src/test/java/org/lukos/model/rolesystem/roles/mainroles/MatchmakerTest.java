...
/**
 * Test cases for {@link Matchmaker}.
 *
 * @author Rick van der Heijden (1461923)
 * @since 12-04-2022
 */
public class MatchmakerTest {
    /** An instance of {@link Matchmaker} that can be used throughout the test cases. */
    private Role matchmaker;
    ...
    public void constructorTest1() {
        assertEquals(CharacterType.NOT_SHADY, matchmaker.getCharacter());
        assertEquals(Group.TOWNSPEOPLE, matchmaker.getGroup());
    }
    ...
    public void initializeActionsTest() {
        ...
        try {
            matchmaker.initializeActions(null);
        } catch (Exception e) {
    ...
    public void performActionTest() {
        Class<?> expected = UnsupportedOperationException.class;
        try {
            matchmaker.performAction(null, null);
        } catch (Exception e) {
            assertTrue(expected.isInstance(e),
                    "type: " + e.getClass().getName() + " should have be instance of " + expected);
            assertNotNull(e.getMessage(), "Message should not be null");
    ...
    public void getInformationTest() {
        Class<?> expected = UnsupportedOperationException.class;
        try {
            matchmaker.getInformation(null, null);
        } catch (Exception e) {
            assertTrue(expected.isInstance(e),
                    "type: " + e.getClass().getName() + " should have be instance of " + expected);
            assertNotNull(e.getMessage(), "Message should not be null");
    ...
    public void replenishActionTest() {
        Class<?> expected = UnsupportedOperationException.class;
        try {
            matchmaker.replenishAction(-1, null);
        } catch (Exception e) {
            assertTrue(expected.isInstance(e),
                    "type: " + e.getClass().getName() + " should have be instance of " + expected);
            assertNotNull(e.getMessage(), "Message should not be null");
