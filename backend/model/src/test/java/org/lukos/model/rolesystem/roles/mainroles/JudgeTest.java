...
/**
 * Test cases for {@link Judge}.
 *
 * @author Rick van der Heijden (1461923)
 * @since 12-04-2022
 */
public class JudgeTest {
    /** An instance of {@link Judge} that can be used throughout the test cases. */
    private Role judge;
    ...
    public void constructorTest1() {
        assertEquals(CharacterType.NOT_SHADY, judge.getCharacter());
        assertEquals(Group.TOWNSPEOPLE, judge.getGroup());
    }
    ...
    public void getInformationTest() {
        Class<?> expected = UnsupportedOperationException.class;
        try {
            judge.getInformation(null, null);
        } catch (Exception e) {
            assertTrue(expected.isInstance(e),
                    "type: " + e.getClass().getName() + " should have be instance of " + expected);
            assertNotNull(e.getMessage(), "Message should not be null");
