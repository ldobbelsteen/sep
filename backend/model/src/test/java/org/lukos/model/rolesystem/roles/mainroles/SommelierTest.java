...
/**
 * Test cases for {@link Sommelier}.
 *
 * @author Rick van der Heijden (1461923)
 * @since 12-04-2022
 */
public class SommelierTest {
    /** An instance of {@link Sommelier} that can be used throughout the test cases. */
    private Role sommelier;
    ...
    public void constructorTest1() {
        assertEquals(CharacterType.NOT_SHADY, sommelier.getCharacter());
        assertEquals(Group.TOWNSPEOPLE, sommelier.getGroup());
    }

    /** @utp.description Tests whether the constructor is demonstrating the correct functionality */
    @Test
    public void constructorTest2() {
        Sommelier sommelier = new Sommelier(true);
        assertEquals(CharacterType.NOT_SHADY, sommelier.getCharacter());
        assertEquals(Group.TOWNSPEOPLE, sommelier.getGroup());
    }
    ...
    public void initializeActionsTest() {
        ...
        try {
            sommelier.initializeActions(null);
        } catch (Exception e) {
    ...
    public void performActionTest() {
        Class<?> expected = UnsupportedOperationException.class;
        try {
            sommelier.performAction(null, null);
        } catch (Exception e) {
            assertTrue(expected.isInstance(e),
                    "type: " + e.getClass().getName() + " should have be instance of " + expected);
            assertNotNull(e.getMessage(), "Message should not be null");
    ...
    public void getInformationTest() {
        Class<?> expected = UnsupportedOperationException.class;
        try {
            sommelier.getInformation(null, null);
        } catch (Exception e) {
            assertTrue(expected.isInstance(e),
                    "type: " + e.getClass().getName() + " should have be instance of " + expected);
            assertNotNull(e.getMessage(), "Message should not be null");
    ...
    public void replenishActionTest() {
        Class<?> expected = UnsupportedOperationException.class;
        try {
            sommelier.replenishAction(-1, null);
        } catch (Exception e) {
            assertTrue(expected.isInstance(e),
                    "type: " + e.getClass().getName() + " should have be instance of " + expected);
            assertNotNull(e.getMessage(), "Message should not be null");
