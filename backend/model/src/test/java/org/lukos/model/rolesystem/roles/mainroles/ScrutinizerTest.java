...
/**
 * Test cases for {@link Scrutinizer}.
 *
 * @author Rick van der Heijden (1461923)
 * @since 12-04-2022
 */
public class ScrutinizerTest {
    /** An instance of {@link Scrutinizer} that can be used throughout the test cases. */
    private Role scrutinizer;
    ...
    public void constructorTest1() {
        assertEquals(CharacterType.NOT_SHADY, scrutinizer.getCharacter());
        assertEquals(Group.TOWNSPEOPLE, scrutinizer.getGroup());
    }

    /** @utp.description Tests whether the constructor is demonstrating the correct functionality */
    @Test
    public void constructorTest2() {
        Scrutinizer scrutinizer = new Scrutinizer(true);
        assertEquals(CharacterType.NOT_SHADY, scrutinizer.getCharacter());
        assertEquals(Group.TOWNSPEOPLE, scrutinizer.getGroup());
    }
    ...
    public void initializeActionsTest() {
        ...
        try {
            scrutinizer.initializeActions(null);
        } catch (Exception e) {
    ...
    public void performActionTest() {
        Class<?> expected = UnsupportedOperationException.class;
        try {
            scrutinizer.performAction(null, null);
        } catch (Exception e) {
            assertTrue(expected.isInstance(e),
                    "type: " + e.getClass().getName() + " should have be instance of " + expected);
            assertNotNull(e.getMessage(), "Message should not be null");
    ...
    public void getInformationTest() {
        Class<?> expected = UnsupportedOperationException.class;
        try {
            scrutinizer.getInformation(null, null);
        } catch (Exception e) {
            assertTrue(expected.isInstance(e),
                    "type: " + e.getClass().getName() + " should have be instance of " + expected);
            assertNotNull(e.getMessage(), "Message should not be null");
    ...
    public void replenishActionTest() {
        Class<?> expected = UnsupportedOperationException.class;
        try {
            scrutinizer.replenishAction(-1, null);
        } catch (Exception e) {
            assertTrue(expected.isInstance(e),
                    "type: " + e.getClass().getName() + " should have be instance of " + expected);
            assertNotNull(e.getMessage(), "Message should not be null");
