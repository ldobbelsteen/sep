...
/**
 * Test cases for {@link CancelGoodbye}.
 ...
 * @since 19-04-2022
 */
public class CancelGoodbyeTest {

    /**
     * Simple constructor test.
     *
     * @utp.description Test whether the {@code CancelGoodbye} object is initialized correctly.
     */
    @Test
    public void constructorTest() {
        assertEquals("CancelGoodbye", new CancelGoodbye().getName(), "uhh, this is odd, the constructor is broken!");
    }
    ...
    public void executeTest() {
        try {
            (new CancelGoodbye()).execute(new PreActionDT(new PlayerIdentifier(1, 1),
