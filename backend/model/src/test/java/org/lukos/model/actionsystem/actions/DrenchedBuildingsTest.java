...
/**
 * Test cases for {@link DrenchedBuildings}.
 ...
 * @since 19-04-2022
 */
public class DrenchedBuildingsTest {

    /**
     * Simple constructor test.
     *
     * @utp.description Test whether the {@code DrenchedBuildings} object is initialized correctly.
     */
    @Test
    public void constructorTest() {
        assertEquals("DrenchedBuildings", new DrenchedBuildings().getName(), "uhh, this is odd, the constructor is broken!");
    }
    ...
    public void executeTest() {
        try {
            (new DrenchedBuildings()).execute(new PreActionDT(new PlayerIdentifier(1, 1),
