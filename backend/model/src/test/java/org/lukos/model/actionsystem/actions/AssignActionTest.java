...
/**
 * Test cases for {@link AssignAction}.
...
public class AssignActionTest {
    ...
    public void constructorTest() {
        assertEquals("AssignAction", new AssignAction().getName(), "uhh, this is odd, the constructor is broken!");
    }
    ...
    public void executeTest() {
        try {
            (new AssignAction()).execute(new PreActionDT(new PlayerIdentifier(1, 1),
