...
/**
 * Test cases for {@link CancelAction}.
 ...
 * @since 19-04-2022
 */
public class CancelActionTest extends ActionTest {

    /**
     * Simple constructor test.
     *
     * @utp.description Test whether the {@code CancelAction} object is initialized correctly.
     */
    @Test
    public void constructorTest() {
        assertEquals("CancelAction", new CancelAction().getName(), "uhh, this is odd, the constructor is broken!");
    }
    ...
    public void executeTest() {
        try {
            (new CancelAction()).execute(new PreActionDT(new PlayerIdentifier(1, 1),
