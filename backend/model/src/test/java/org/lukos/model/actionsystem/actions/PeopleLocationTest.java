...
/**
 * Test cases for {@link PeopleLocation}.
 ...
 * @since 19-04-2022
 */
public class PeopleLocationTest {

    /**
     * Simple constructor test.
     *
     * @utp.description Test whether the {@code PeopleLocation} object is initialized correctly.
     */
    @Test
    public void constructorTest() {
        assertEquals("PeopleLocation", new PeopleLocation().getName(), "uhh, this is odd, the constructor is broken!");
    }
    ...
    public void executeTest() {
        try {
            (new PeopleLocation()).execute(new PreActionDT(new PlayerIdentifier(1, 1),
