...
/**
 * Test cases for {@link Hitman}.
 *
 * @author Rick van der Heijden (1461923)
 * @since 12-04-2022
 */
public class HitmanTest {
    /** An instance of {@link Hitman} that can be used throughout the test cases. */
    private Role hitman;

    @BeforeEach
    public void setUp() {
        this.hitman = new Hitman();
    }

    /** @utp.description Tests whether the constructor is demonstrating the correct functionality */
    @Test
    public void constructorTest1() {
        assertEquals(CharacterType.SHADY, hitman.getCharacter());
        assertEquals(Group.HITMAN, hitman.getGroup());
    }

    /** @utp.description Tests whether the constructor is demonstrating the correct functionality */
    @Test
    public void constructorTest2() {
        Hitman hitman = new Hitman(null);
        assertEquals(CharacterType.SHADY, hitman.getCharacter());
        assertEquals(Group.HITMAN, hitman.getGroup());
    }
    ...
    public void performActionTest() {
        Class<?> expected = UnsupportedOperationException.class;
        try {
            hitman.performAction(null, null);
        } catch (Exception e) {
            assertTrue(expected.isInstance(e),
                    "type: " + e.getClass().getName() + " should have be instance of " + expected);
            assertNotNull(e.getMessage(), "Message should not be null");
    ...
    public void getInformationTest() {
        Class<?> expected = UnsupportedOperationException.class;
        try {
            hitman.getInformation(null, null);
        } catch (Exception e) {
            assertTrue(expected.isInstance(e),
                    "type: " + e.getClass().getName() + " should have be instance of " + expected);
            assertNotNull(e.getMessage(), "Message should not be null");
