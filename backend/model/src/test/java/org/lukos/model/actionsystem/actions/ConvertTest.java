...
public class ConvertTest {
     ...
     *
     * @utp.description Test whether the {@code Convert} object is initialized correctly.
     */
    @Test
    public void constructorTest() {
        assertEquals("Convert", new Convert().getName(), "uhh, this is odd, the constructor is broken!");
    }
    ...
    public void executeTest() {
        try {
            (new Convert()).execute(new PreActionDT(new PlayerIdentifier(1, 1),
