...
/**
 * Test cases for {@link CultLeader}.
 *
 * @author Rick van der Heijden (1461923)
 * @since 12-04-2022
 */
public class CultLeaderTest {
    /** An instance of {@link CultLeader} that can be used throughout the test cases. */
    private Role cultLeader;

    @BeforeEach
    public void setUp() {
        this.cultLeader = new CultLeader();
    }

    /** @utp.description Tests whether the constructor is demonstrating the correct functionality */
    @Test
    public void constructorTest1() {
        assertEquals(CharacterType.VAGUE, cultLeader.getCharacter());
        assertEquals(Group.CULT, cultLeader.getGroup());
    }

    /** @utp.description Tests whether the constructor is demonstrating the correct functionality */
    @Test
    public void constructorTest2() {
        CultLeader cultLeader = new CultLeader(true);
        assertEquals(CharacterType.VAGUE, cultLeader.getCharacter());
        assertEquals(Group.CULT, cultLeader.getGroup());
    }
    ...
    public void initializeActionsTest() {
        ...
        try {
            cultLeader.initializeActions(null);
        } catch (Exception e) {
    ...
    public void performActionTest() {
        Class<?> expected = UnsupportedOperationException.class;
        try {
            cultLeader.performAction(null, null);
        } catch (Exception e) {
            assertTrue(expected.isInstance(e),
                    "type: " + e.getClass().getName() + " should have be instance of " + expected);
            assertNotNull(e.getMessage(), "Message should not be null");
    ...
    public void getInformationTest() {
        Class<?> expected = UnsupportedOperationException.class;
        try {
            cultLeader.getInformation(null, null);
        } catch (Exception e) {
            assertTrue(expected.isInstance(e),
                    "type: " + e.getClass().getName() + " should have be instance of " + expected);
            assertNotNull(e.getMessage(), "Message should not be null");
    ...
    public void replenishActionTest() {
        Class<?> expected = UnsupportedOperationException.class;
        try {
            cultLeader.replenishAction(-1, null);
        } catch (Exception e) {
            assertTrue(expected.isInstance(e),
                    "type: " + e.getClass().getName() + " should have be instance of " + expected);
            assertNotNull(e.getMessage(), "Message should not be null");
