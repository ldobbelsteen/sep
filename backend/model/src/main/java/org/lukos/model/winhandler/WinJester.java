...
/**
 * Implementation of {@link WinHandler} which checks whether the {@link Group} {@code JESTER} won.
 *
 * @author Rick van der Heijden (1461923)
 * @since 03-03-2022
 */
public class WinJester extends WinHandler {

    /** Constructs a {@code WinJester}. */
    public WinJester() {
        super(Group.JESTER);
    }

    /**
     * Constructs a {@code WinJester} with the next {@code WinHandler} in the chain.
     *
     * @param next The next {@code WinHandler} in the chain.
     */
    public WinJester(WinHandler next) {
        super(Group.JESTER, next);
    }
